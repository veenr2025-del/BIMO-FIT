...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("./sw.js").catch(() => {
      showToast("Offline installatie is niet actief op file://. Gebruik een lokale of online server.");
    });
  });
}
  ...
  return `
    <section class="hero-section">
      <div class="hero-copy">
        ...
        <h1>${member ? `Welkom, ${escapeHtml(member.name)}` : "Start je fit journey bij BIMO"}</h1>
...
function renderRanking() {
  ...
  return `
    <section class="page-heading">
      ...
      <p>Ranking wordt gevoed door admin-bevestigde punten en QR-aanwezigheid.</p>
    </section>
